...
This script downloads the pinned `ffmpeg_dlls_for_hwenc` archive into `ffmpeg_lgpl`, verifies the required FFmpeg 62 runtime DLLs, and stages them into any existing x64 build output directories.
